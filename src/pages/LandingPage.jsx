  ...
  const features = [
    {
      ...
      description: t('features.globalPayments.description')
    },
    {
      title: t('features.fxServices.title'),
      description: t('features.fxServices.description')
    },
    {
  ...
  return (
    <div className="min-h-screen bg-bgPpal-light dark:bg-bgPpal-dark font-sans">
      ...
      <main>
        ...
        {/* Sección de características - ahora dentro del flujo principal */}
        <FeaturesSection t={t} />
      </main>
    </div>
  );
